...
export class Circle {
  ...
  render() {
    ...
    <!-- Add text -->
    <text x="100" y="100" dominant-baseline="middle" text-anchor="middle" fill="${this.textColor}" font-size="40">
      ${this.text}
    </text>
  </svg>`
...
export class Triangle {
 ...
 return `<svg xmlns="http://www.w3.org/2000/svg" width="300" height="200">
  ...
  <!-- Add text -->
  <text x="100" y="130" text-anchor="middle" fill="${this.textColor}" font-size="30">
  ${this.text}
  </text>
</svg>`
  }
...
export class Square {
  ...
  render() {
    ...
    <!-- Add white text -->
    <text x="75" y="75" text-anchor="middle" alignment-baseline="middle" fill="${this.textColor}" font-size="40">
      ${this.text}
    </text>
  </svg>`
  }
